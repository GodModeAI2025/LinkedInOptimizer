...
Die Einwilligung endet beim Kunden. Alle anderen Personen, die in den Daten auftauchen, stehen außerhalb dieser Grenze. Dafür hat das Repo keinen Mechanismus.
...
3. **Kein Schutz gegen Anweisungen aus fremden Profilen.** Siehe Trust Boundaries. Erhobener Seitentext wird nicht als Daten gekennzeichnet, es gibt keine Trennung zwischen Skill-Anweisung und Profilinhalt.
...
5. **Keine Einwilligungsstufe für Dritte.** Phase 3 und Phase 6.2 benennen Personen, ohne dass ein Schritt fragt, ob diese Verarbeitung gedeckt ist. Es gibt keinen Code, der eine Verarbeitung verweigern könnte, und kein Audit-Log.
